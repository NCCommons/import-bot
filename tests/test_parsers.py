...
class TestNCTemplateEdgeCases:
    ...
    def test_to_file_syntax_with_special_chars(self):
        ...
        template = NCTemplate(
            original_text="{{NC|test's (2).jpg|Caption}}",
            filename="test's (2).jpg",
    ...
    def test_to_file_syntax_with_wikitext_caption(self):
        ...
        template = NCTemplate(
            original_text="{{NC|test.jpg|Caption with [[link]]}}",
            filename="test.jpg",
            caption="Caption with [[link]]"
        )
